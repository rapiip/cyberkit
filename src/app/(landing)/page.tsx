...
const stats = [
  { value: '11', label: 'Workspaces', icon: Globe2 },
  { value: '40+', label: 'Security Tools', icon: Zap },
  { value: '9', label: 'Categories', icon: Cpu },
  { value: '4', label: 'Learning Labs', icon: Bug },
];
          ...
          {stats.map((stat) => (
            <StaggerItem key={stat.label}>
              <div className="text-center">
                ...
                <div className="stat-glow text-4xl font-bold md:text-5xl">{stat.value}</div>

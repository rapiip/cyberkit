...
const labs = [
  {
    ...
    description: 'Learn how SQL injection attacks work by exploiting a simulated vulnerable login form. Understand parameterized queries and input validation.',
  ...
  },
  {
    id: 'xss',
    name: 'XSS Lab',
    description: 'Explore Cross-Site Scripting (XSS) vulnerabilities. Learn how to inject scripts and understand proper output encoding.',
    difficulty: 'Intermediate',
    color: '#f59e0b',
  ...
  },
  {
    ...
    description: 'Learn how SQL Injection allows bypassing standard username/password authentication mechanisms in database search queries.',
    difficulty: 'Intermediate',
    color: '#06b6d4',
  ...
  },
  {
    ...
    description: 'Witness how a malicious site can hijack authenticated session cookies to execute unauthorized actions on vulnerable bank applications.',
    difficulty: 'Intermediate',
    color: '#f43f5e',
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8">
      ...
      <div className="glass-card p-4 flex items-start gap-3 border-cyber-amber/30">
        ...
        <div className="text-sm text-muted-foreground">
          <strong className="text-cyber-amber">Educational Purpose Only.</strong> These labs simulate vulnerabilities in a safe, sandboxed environment. Never attempt these techniques on systems you don&apos;t own.
        </div>
      </div>
